      ...
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="position-relative">
            ...
            <img src="/backend/assets/images/profile_cover1560x370.png" class="rounded-top" alt="profile cover">


            </figure>
            <div class="d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-2 px-md-4 mt-n4">
            <div>
                <img class="wd-70 rounded-circle" src="/backend/assets/images/100x100.svg" alt="profile">
